...
_REQUIREMENTS_PRESENT="Krav oppfylt, fortsetter ..."
_RELIES_ON_CURL="Dette skriptet avhenger av at curl er installert, men vi kunne ikke installere det"
_UNKNOWN_ERROR="Ukjent feil!"
_CURL_UNKNOWN_ERROR_INSTALL="Testen for curl feilet med ukjent feilmelding"