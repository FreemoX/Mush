...
_REQUIREMENTS_PRESENT="Requirements present, continuing ..."
_RELIES_ON_CURL="This script relies on curl to function, but it could not be installed"
_UNKNOWN_ERROR="Unknown error!"
_CURL_UNKNOWN_ERROR_INSTALL="Curl check failed with unknown error"